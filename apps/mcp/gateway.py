...
# Ensure service-scoped env layering resolves before downstream imports.
os.environ.setdefault("MINSY_SERVICE", "mcp")

from apps.mcp.domains.backtest import TOOL_NAMES as BACKTEST_TOOL_NAMES
from apps.mcp.domains.backtest import register_backtest_tools
from apps.mcp.domains.market_data import TOOL_NAMES as MARKET_DATA_TOOL_NAMES
from apps.mcp.domains.market_data import register_market_data_tools
from apps.mcp.domains.strategy import TOOL_NAMES as STRATEGY_TOOL_NAMES
from apps.mcp.domains.strategy import register_strategy_tools
from apps.mcp.domains.stress import TOOL_NAMES as STRESS_TOOL_NAMES
from apps.mcp.domains.stress import register_stress_tools
from apps.mcp.domains.trading import TOOL_NAMES as TRADING_TOOL_NAMES
from apps.mcp.domains.trading import register_trading_tools
from packages.infra.observability.logger import configure_logging, logger
from packages.infra.observability.sentry import init_backend_sentry
from packages.shared_settings import get_mcp_settings
...
def main() -> int:
    ...
    configured_log_level = str(os.getenv("LOG_LEVEL", "")).strip() or settings.log_level
    configure_logging(level=configured_log_level, show_sql=False)
