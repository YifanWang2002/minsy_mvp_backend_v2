...
| strategy | artifact_ops | strategy | read-only | yes | strategy_id available | strategy_validate_dsl, strategy_get_dsl, strategy_list_tunable_params, strategy_list_versions, strategy_get_version_dsl, strategy_diff_versions, get_indicator_detail, get_indicator_catalog |
...
| stress_test | feedback | strategy | read-only | no | legacy only (redirected to strategy) | strategy_validate_dsl, strategy_get_dsl, strategy_list_tunable_params, strategy_list_versions, strategy_get_version_dsl, strategy_diff_versions, get_indicator_detail, get_indicator_catalog |
